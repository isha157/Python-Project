...
recipient_number = input('Enter the recipient whatsappp number with country code (e.g. +12345)')
...
if delay_seconds <=0:
    print('The specified time is in the part. Please enter a future date nd time: ')
else:
    print(f'Message scheduled to be sent to {name} at {schedule_datetime}.')

    #wait untile the scheduled time
